    ...
    <div class="row dashboard-nowrap">
        ...
        <div class="m-4 p-3 width-medium">
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                ...
                <div class="alert">Czy nadal pewno chcesz usunąć przepis z planu?
                </div>
                <form action="/app/removeRecipe" method="post">
                    ...
                    <div class="btn btn-success rounded-0 pt-0 pb-0 pr-4 pl-4"><a href="/app/recipe">Anuluj</a></div>
                </form>
            </div>
        </div>
    </div>
