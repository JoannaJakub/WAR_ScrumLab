...
<section class="dashboard-section">
    <div class="row dashboard-nowrap">
        <ul class="nav flex-column long-bg">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/super-admin-users.jsp">
        ...
        <div class="m-4 p-3 width-medium">
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                <div class="row border-bottom border-3 p-1 m-1">
                    ...
                    <div class="col noPadding d-flex justify-content-end mb-2"><a href="/app-add-recipe.jsp" class="btn btn-success rounded-0 pt-0 pb-0 pr-4 pl-4">Dodaj przepis</a></div>
                </div>
                <table class="table border-bottom schedules-content">
                    ...
                    <tr class="d-flex">
                        ...
                        <td class="col-2 d-flex align-items-center justify-content-center flex-wrap">
                            ...
                            <a href="/app-recipe-details.jsp" class="btn btn-info rounded-0 text-light m-1">Szczegóły</a>
                            <a href="/app-edit-recipe.jsp" class="btn btn-warning rounded-0 text-light m-1">Edytuj</a>
                        </td>
                    </tr>
                    <tr class="d-flex">
