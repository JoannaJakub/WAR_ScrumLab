        ...
        <div class="m-4 p-3 width-medium">
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                <div class="row border-bottom border-3 p-1 m-1">
                    <div class="col noPadding"><h3 class="color-header text-uppercase">Przepisy naszych użytkowników:</h3></div>
                </div>
                <table class="table border-bottom schedules-content">
                    ...
                    <c:forEach begin="0" step="1" end="${recipes.size()-1}" var="number">
                        ...
                        <tr class="d-flex p-2">
                            ...
                            <td class="flex-box" ><a href="#" class="btn btn-info pull-right rounded-0 text-light">Szczegóły</a></td>
                        </tr>
